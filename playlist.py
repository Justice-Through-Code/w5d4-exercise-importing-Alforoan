...
add_song(my_playlist, {'artist': "john leonard", "title": "imagine"})
'''
...
add_song(my_playlist, {'artist': "taylor swift", "title": "21"})
add_song(my_playlist, {'artist': "bruno mars", "title": "grenade"})
